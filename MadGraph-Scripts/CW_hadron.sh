...
echo "generate p p > e- e+ w+ / a z h vl vl~, w+ > j j QCD=99 QED=99">>runMG_$N.sh
echo "add process p p > e- e+ w- / a z h vl vl~, w- > j j QCD=99 QED=99">>runMG_$N.sh
echo "add process p p > mu- mu+ w+ / a z h vl vl~, w+ > j j QCD=99 QED=99">>runMG_$N.sh
echo "add process p p > mu- mu+ w- / a z h vl vl~, w- > j j QCD=99 QED=99">>runMG_$N.sh
echo "output clockwork_"$N"_"$m1"_GeV_"$E"_TeV">>runMG_$N.sh
...
echo "set mmjj 70.0">>runMG_$N.sh
echo "set mmjjmax 90.0">>runMG_$N.sh
